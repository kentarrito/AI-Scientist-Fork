# This launcher makes agents in ai_scientist/agents
...
if __name__ == "__main__":
    ...
    """
    pre_agents are generated by 4o with prompt 'I'm trying to make prompts to make LLM brainstorm. For example, "Let's think another way" is a prompt to let llm change their thinking way. Give me 10 of these prompts.'
    """
    brainstorming_history=""
    base_dir = osp.join("templates", args.experiment)
    results_dir = osp.join("results", args.experiment)
    for i in range(10):
        ideas, brainstorming_history = generate_ideas_with_brainstorming(
            base_dir,
            agents=pre_agents,
